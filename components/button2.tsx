  ...
  return isLoading ?? pending ? (
    ...
    <button
      ...
      className={`px-6 ${
        ...
        !fullWidth && "mx-auto"
      } h-10 disabled:bg-neutral-400 disabled:text-neutral-300 disabled:cursor-not-allowed font-semibold active:scale-90 ${
        method === "delete" ? "delete-btn" : "primary-btn"
      } ${rounded && "rounded-full"} ${
        outlined &&
        "bg-transparent border border-orange-400 *:text-orange-400 *:font-medium *:hover:font-semibold *:hover:text-white"
      }`}
