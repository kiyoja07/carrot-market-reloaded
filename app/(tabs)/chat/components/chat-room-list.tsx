...
import { formatToTimeAgo, parsePhotoUrl } from "@/lib/utils";
  ...
  return (
    chatRoom && (
      <div className="hover:scale-x-105 transition">
        <div
          className={`${
            lastMsg.userId !== user.id
              ? "border-orange-500 border bg-orange-50 dark:bg-transparent"
              : "bg-neutral-300 dark:bg-neutral-700"
          } rounded-xl mx-4 mb-1 mt-4 py-4 px-6 flex items-center justify-between`}
        >
          <div>
          ...
          <div className="w-28">
            <Button0 onClick={() => router.push(`/chats/${chatRoom.id}`)}>
              입장하기
            </Button0>
          </div>
        </div>
